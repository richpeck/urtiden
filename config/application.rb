  ...
  class Application < Rails::Application
    ...
    ##########################################
      ...
      Sidekiq.configure_client do |config|
        config.redis = {
          url: "redis://#{Rails.application.credentials.dig(Rails.env.to_sym, :redis, :host)}:#{Rails.application.credentials.dig(Rails.env.to_sym, :redis, :port)}",
          password:  Rails.application.credentials.dig(Rails.env.to_sym, :redis, :pass)
        }
      end
